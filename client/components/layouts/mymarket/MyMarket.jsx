...
const MyMarket = props => {
    ...
    const getDetail = (item) => {
        navigate("/item-details-01", { state: { ...item, markettype: 3 } })
    }
    const showMoreItems = () => {
                                ...
                                <div className="sc-card-product">
                                    <div className="card-media">
                                        ...
                                        <div className="button-place-bid">
                                            ...
                                            }} className="sc-button style-place-bid style bag fl-button pri-3"><span>Cancel Sale</span></button>
